...
<form id="ff" method="post" class="myfm">
    <div class="myfitem">
        <div>
            <label for="supId">供应商编号:</label> <input class="easyui-textbox"
                                                     data-options="readonly: true,missingMessage: '请填写供应商编号！'"
                                                     name="supId"/>
        </div>
        <div>
            <label for="supName">供应商:</label> <input class="easyui-textbox"
                                                     data-options="required: true,missingMessage: '请填写供应商！'"
                                                     name="supName">
        </div>
        <div>
            <label for="supLinkman">联系人:</label> <input class="easyui-textbox"
                                                        data-options="required: true,missingMessage: '请联系人！'"
                                                        name="supLinkman"/>
        </div>
        <div>
            <label for="supPhone">联系电话:</label> <input class="easyui-textbox"
                                                       data-options="required: true,missingMessage: '请填写联系电话！'"
                                                       name="supPhone"/></div>
        <div>
            <label for="supAddress">联系地址:</label> <input class="easyui-textbox"
                                                         data-options="required: true,missingMessage: '请填写联系地址！'"
                                                         name="supAddress"/>
        </div>
        <div>
            <label for="supPay">期初应付:</label> <input class="easyui-textbox" name="supPay"/>
        </div>
        <div>
            <label for="supType">供应商类型：</label>
            <select id="cc" class="easyui-combobox" data-options="required: true,missingMessage: '请填写供应商类型！'"
                    name="supType" style="width:200px;">
